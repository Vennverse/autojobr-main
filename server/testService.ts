...
export class TestService {
  ...
  private getPredefinedTemplates(): InsertTestTemplate[] {
    // Each template now uses 2 questions per minute ratio
    return [
      // TECH PLATFORM TEMPLATES (3) - With CS questions and extreme difficulty
      {
        title: "Senior Software Engineer Assessment",
        description: "Comprehensive technical evaluation for senior software engineering roles including algorithms, system design, and coding best practices. 240 questions in 120 minutes.",
        category: "technical",
      ...
      },
      {
        ...
        description: "End-to-end assessment covering frontend, backend, databases, and system architecture. 180 questions in 90 minutes.",
        category: "technical",
      ...
      },
      {
        ...
        description: "Expert-level assessment for principal/staff engineering roles. 300 questions in 150 minutes.",
        category: "technical",
        jobProfile: "software_engineer",
        difficultyLevel: "expert",
        timeLimit: 150,
      ...
      // FINANCE PLATFORM TEMPLATES (2) - With finance questions
      {
        ...
        description: "Rigorous evaluation covering financial modeling, valuation, market analysis. 240 questions in 120 minutes.",
        category: "technical",
        jobProfile: "finance",
        difficultyLevel: "expert",
        timeLimit: 120,
      ...
      },
      {
        ...
        description: "Specialized assessment for risk management roles. 200 questions in 100 minutes.",
        category: "technical", 
        jobProfile: "finance",
        difficultyLevel: "expert",
        timeLimit: 100,
      ...
      // SALES & MARKETING PLATFORM TEMPLATES (2)
      {
        ...
        description: "Comprehensive evaluation for B2B sales roles. 150 questions in 75 minutes.",
        category: "behavioral",
        jobProfile: "sales",
      ...
      },
      {
        ...
        description: "Modern marketing assessment covering analytics and campaigns. 120 questions in 60 minutes.",
        category: "technical",
      ...
      },
      {
        ...
        description: "Strategic assessment for operations roles. 160 questions in 80 minutes.",
        category: "behavioral",
      ...
      },
      {
        ...
        description: "Technical evaluation for DevOps roles. 200 questions in 100 minutes.",
        category: "technical", 
